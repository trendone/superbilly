    ...
    <div className="dash">
      <div className="ana-head">
        <div>
          ...
          <p className="hint">
            Offene Zoho-Deals (Angebot verschickt / Angebot nachgefasst / Verhandlungsphase, Consulting)
            als weiche, wahrscheinlichkeitsgewichtete Last. Erscheint nicht in der Planung.
          </p>
        </div>
